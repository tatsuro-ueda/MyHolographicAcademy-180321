...
{
    /// <summary>
    /// ユーザの手がカメラの視野を出そうになったら手の誘導表示を表示する
    /// </summary>
    public class MyHandGuidance : Singleton<HandGuidance>
    {
        [Tooltip("HandGuidanceIndicator が周囲に配置される Cursor オブジェクト")]
        public GameObject Cursor;

        [Tooltip("手の追跡を失いそうになったら表示される GameObject")]
        public GameObject HandGuidanceIndicator;

        // 誘導表示を表示し始める、手を見失う危険度
        // 危険度が1に近づくと、手が視野の外に出そうになっていることを示している
        [Range(0.0f, 1.0f)]
